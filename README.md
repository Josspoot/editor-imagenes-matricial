...
### Lo que más me costó
- **Ejercicio 2.1 Me costo poner ciertos valores de los bucles
- **Ejercicio 2.3 Me cosnto terminar de entender algunos conceptos que pedia 

### Lo que más me gustó
- **Manipulacion de imagenes**: poder utilizar imagenes y ver la relación que tienen con matrices 
- **Apredndiaje de JS**: aprender un poco de uno de los lenguajes de programacion mas importantes 

### Técnicas aplicadas
- Uso de `for` loops para iteraciones
- Matrices
- Comandos con la terminal `.push()`
...
### Función Favorita: Mezclar imagenes
```javascript
...
**Por qué me gusta:** Por el hecho de poder mezclar las imagenes lo cual es algo curioso
...
- **Email Institucional:** [josue.poot@tecdesoftware.edu.mx]
- **GitHub:** [@josspoot](https://github.com/josspoot)
...
Hecho con 💙 por [Josue Enmanuel Poot Mateo] - 2025
